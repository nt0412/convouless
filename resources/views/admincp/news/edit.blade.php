                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('news.store')}}">
                            ...
                            <div class="form-group">
                                ...
                                <!-- <input type="text" class="form-control" value="{{$news->news_content}}" id="exampleInputEmail1" name="news_content" placeholder="Content"> -->
                                {{-- <textarea class="form-control"  name="news_content" placeholder="Content" cols="30" rows="10">{{$news->news_content}}</textarea> --}}
                                <textarea cols="80" id="editor1" name="news_content" rows="10" data-sample-short>{{$news->news_content}}</textarea>
                            </div>
