        ...
        <div class="row">
                ...
                <div class="row" style="margin-right: 0;">
                    ...
                    <div class="col-sm-6" style="background: black;">
                        <div class="title-main">
                            ...
                            <h5 class="hot-news-author">By <a href="#">Teen tac gia</a></h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-4" style="padding: 1px;">
                ...
                <div class="hot-title">
                    ...
                    <h5 class="hot-news-author-mini">By <a href="#">Teen Tac gia</a></h5>
                </div>
            </div>
        </div>
        ...
        <div class="row" style="margin-right: 0;">
            ...
            <div class="col-sm-8 " style="padding: 1px;">
                <div class="row">
                    ...
                    <div class="col-sm-6" style="background: black; margin-right: -1;">
                        <div class="title-main">
                            <a href="{{route('news.show',[$newshot1_4->news_slug])}}">
                                <h2 class="title-big">{{ $newshot1_4->news_title }} </h2>
                            </a>
                            <h5 class="hot-news-author" style="padding-top: 0;">By <a href="#">Teen tac gia</a></h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-dark">
                    ...
                    <div class="hot-title">
                        <a href="{{route('news.show',[$newshot1_5->news_slug])}}">
                            <h4 class="title-mini">{{ $newshot1_5->news_title }}</h4>
                        </a>
                        <h5 class="hot-news-author-mini">By <a href="#">Teen Tac gia</a></h5>
                    </div>
                </div>
                ...
                <div class="card bg-dark">
                    ...
                    <div class="hot-title">
                        <a href="{{route('news.show',[$newshot1_6->news_slug])}}">
                            <h4 class="title-mini">{{ $newshot1_6->news_title }}</h4>
                        </a>
                        <h5 class="hot-news-author-mini">By <a href="#">Teen Tac gia</a></h5>
                    </div>
                </div>
                ...
                <div class="card bg-dark">
                    ...
                    <div class="hot-title">
                        <a href="{{route('news.show',[$newshot1_7->news_slug])}}">
                            <h4 class="title-mini">{{ $newshot1_7->news_title }}</h4>
                        </a>
                        <h5 class="hot-news-author-mini">By <a href="#">Teen Tac gia</a></h5>
                    </div>
                </div>
