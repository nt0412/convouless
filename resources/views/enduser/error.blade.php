...
<body>
    ...
    <div class="text" style="text-align: center;">
        <h1 style="color: whitesmoke;">Sorry, You don't have permission to access !</h1>
        <h2 style="color: white;">You can contact to us to get a permission</h2>
        <h1 style="font-family: 'Anton';"><a href="{{ url('/') }}">GO BACK</a></h1>
    </div>
</body>
